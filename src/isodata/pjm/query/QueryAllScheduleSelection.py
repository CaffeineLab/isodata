"""QueryAllScheduleSelection - To request all schedules associated with a unit location or the locations of a portfolio, execute the
following query request.
<QueryRequest>
 <QueryAllScheduleSelection day="yyyy-mm-dd" available="xxx">
 <All/>
